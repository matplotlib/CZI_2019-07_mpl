...
To strengthen the library and lay the groundwork for future versions, this 
 proposal asks for 2.4 person years of developer effort to support:
  %%does this have any semantic meeting?
...
\begin{enumerate}[label=\alph*),noitemsep]
  ...
  \item Maintaining the code base, e.g. triaging issues and pull requests (PRs) and fixing bugs
...
Matplotlib is a community-driven project, but we have grown to the point where we need supported developers with the time to organize, plan, and make timely decisions. Currently, new Issues and PRs
...
% to say here.
%% also this is some serious levels of community work
% TAC: considered just removing it, but I like HA's suggestion of adding a
...
%% 75% of issues are closed within 7 days & 75% of PRs are merged w/in 7 days, (closed within 10)
%% about 50% are closed within a day
%% we need better triaging and closing policies for the 25%
...
\item Hannah Aizenman's position for 12 months.  Aizenman has
  ...
  %% dunno, like mostly if I'm responsibly for new contributor onboarding,
  %% do I need to explain why I'm qualified to do this?
  % no
