...
% contemplating deleting "with the time"
...
%% An example of what sort of surprising and undesired coupling?
% hard to do without a bunch of jargon, with admittedly we go into
% below
